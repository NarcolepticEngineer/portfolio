(function(dice) {
    ...
    this.standart_d100_dice_face_labels = [' ', '🔥', '10', '20', '30', '40', '50',
        '60', '70', '80', '90'
    ];
    ...
    // DICE COLOR SETTINGS
    this.label_color = '#C3FFFF';
    this.dice_color = '#009D9D';
    ...
    this.dice_inertia = { 'd4': 15, 'd6': 23, 'd8': 20, 'd10': 19, 'd12': 18, 'd20': 16, 'd100': 19 };
